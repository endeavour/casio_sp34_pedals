...
In addition it's worth noting that if you take the plastic casing off, the SP-34 will fit into the furniture cabinet of a PX-730 and other similar models. The only difference being that the cabling goes to the left instead of the right. But since that's where my Pianoteq PC is that was actually a bonus.

See pinouts.txt for the pinouts.
